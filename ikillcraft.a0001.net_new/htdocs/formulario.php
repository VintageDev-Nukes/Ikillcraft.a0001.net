...
<span id="def" class="eurowrapper"><br>  <b>Link del juego:</b>
...
<br></span>
<span id="flash" class="eurowrapper"><br>  <b>Link del juego:</b>
   <input type="text" value="" name="link_juego" />
<br><b>Ancho:</b> <input type="text" name="ancho" id="ancho" MAXLENGTH=4 SIZE=1 /> px.
<br><b>Alto:</b> <input type="text" name="alto" id="alto" MAXLENGTH=4 SIZE=1 /> px.
<br></span>
<span id="java" class="eurowrapper"><br>  <b>Link del juego:</b>
   <input type="text" value="" name="link_juego" />
<br><b>Ancho:</b> <input type="text" name="ancho" id="ancho" MAXLENGTH=4 SIZE=1 /> px.
<br><b>Alto:</b> <input type="text" name="alto" id="alto" MAXLENGTH=4 SIZE=1 /> px.
<br></span>
<span id="unity" class="eurowrapper"><br>  <b>Link del juego:</b>
   <input type="text" value="" name="link_juego" />
<br><b>Ancho:</b> <input type="text" name="ancho" id="ancho" MAXLENGTH=4 SIZE=1 /> px.
<br><b>Alto:</b> <input type="text" name="alto" id="alto" MAXLENGTH=4 SIZE=1 /> px.
<br></span>
<span id="iframe" class="eurowrapper"><br>  <b>Link del juego:</b>
   <input type="text" value="" name="link_juego" />
<br><b>Ancho:</b> <input type="text" name="ancho" id="ancho" MAXLENGTH=4 SIZE=1 /> px.
<br><b>Alto:</b> <input type="text" name="alto" id="alto" MAXLENGTH=4 SIZE=1 /> px.
<br></span>
