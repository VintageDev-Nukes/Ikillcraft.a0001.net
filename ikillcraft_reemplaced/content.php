...
<div style="width: 510px; height: 125px; left: 135px;top: 146px;background:#fff; z-index: 6; position: absolute;display:none;" id="wait"><center><h1><?php echo text3; ?></h1><img src="http://revistav.uvm.edu.ve/admincontenido/images/load.gif" style="width:32px; height:32px;"></center></div>
<div style="position:relative; top:-20px; width:510px; background:#fff; z-index:5;border-top: 1px #000 solid;border-left: 1px #000 solid;border-right: 1px #000 solid;padding-top: 5px;">
<?php echo text4; ?><br>
...
<iframe id="marco" src="http://www.youtube.com/subscribe_widget?p=ikillnukes4evertmb" style="overflow: hidden; height: 105px; width: 300px; border: 0; position:relative; left:45px; z-index:0;top: -1px;" scrolling="no" frameborder="0"></iframe></div>
